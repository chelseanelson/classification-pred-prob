...
# look at price it is now a character variable maybe for the next one can change this 
...
airbnb_splits <- airbnb_data %>% 
  initial_split(prop = 0.75, strata = host_is_superhost)
...
save(airbnb_splits, file = here("data/model_data/round_1/airbnb_splits.rda"))
