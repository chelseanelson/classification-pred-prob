...
airbnb_univariate <- airbnb_data %>% ggplot(aes(host_is_superhost)) + 
  geom_bar(stat = "count", fill = "skyblue", color = "black") + labs(
...
save(airbnb_splits, file = here("data/model_data/round_3/airbnb_splits.rda"))
